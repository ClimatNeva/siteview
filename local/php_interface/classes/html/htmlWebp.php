 ...
 * htmlWebp
 *
 * Класс преобразования в формат webp
 * 
 * Оригинальное название: Bas\Pict
 */
class htmlWebp {
	...
	public static function resizePict($file, $width, $height, $isProportional = true, $intQuality = 100)
	{
		...
		$file = \CFile::ResizeImageGet($file, array('width'=>$width, 'height'=>$height), ($isProportional ? BX_RESIZE_IMAGE_PROPORTIONAL : BX_RESIZE_IMAGE_EXACT), true, ["name" => "sharpen", "precision" => 0], false, $intQuality);
