				...
				<table width="100%" class="bxr-table-row-action ">
					<tr>
						...
						<td class="basket-name xs-hide">
							...
							<b class="basket-price bxr-format-price"><?=$arBasketItem["FORMAT_PRICE"]?><br><span class="bxr-market-current-price-denom"><?=CurrencyFormat($arBasketItem["PRICE"]*$denomination, $arBasketItem["CURRENCY"])?></span></b>
						</td>
