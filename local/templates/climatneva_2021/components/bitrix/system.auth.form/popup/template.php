...
<div class="bx_login_block">
	...
	$frame = $this->createFrame("login-line", false)->begin();
		...
		?>
			...
			<a class="bx_login_top_inline_link" href="javascript:void(0)" onclick="window.location.assign('/auth/?register=yes&backurl=' + window.location.pathname);"><?=GetMessage("AUTH_REGISTER")?></a>
			<?endif;
		}
		else
		{
