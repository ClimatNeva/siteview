		...
		<div class="containter">
			...
			<div class="span_2_of_4">
				<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
					<!--noindex-->
						<a href="javascript:void(0);<?//=$arParams["AUTH_FORGOT_PASSWORD_URL"] ? $arParams["AUTH_FORGOT_PASSWORD_URL"] : $arResult["AUTH_FORGOT_PASSWORD_URL"]
                           ?>" onclick="window.location.assign('/auth/?forgot_password=yes');" rel="nofollow"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a>
					<!--/noindex-->
				<?endif?>
			</div>
