...
?>
	...
	<div class="bxr-ecommerce-v2-lite" data-uid="<?=$UID?>" data-resize="1" id="<?=$arItemIDs["ID"]?>">
...
$elementDraw->setAdditionalFile("JS", "/bitrix/templates/.default/bxready/library/elements/ecommerce.v2.lite/include/script.js", true);
$elementDraw->setAdditionalFile("CSS", "/bitrix/templates/.default/bxready/library/elements/ecommerce.v2.lite/include/style.css", false);
?>
