...
//	$view = trim(strip_tags($_REQUEST["view"]));
    ...
    //$GLOBALS["arrFilter"]["PROPERTY_MOUNT_COST"] = $actionsFilter['arID'];
	global $arrFilter;

	$arrFilter = [];
	//
	$arrFilter = $globalElementsFilter;
	//$arrFilter["IBLOCK_SECTION_ID"] = ["104"];
	//$arrFilter["PROPERTY_STRANA"] = ["Китай"];
	//$arrFilter["ID"] = ["1903", "1904"];

	//echo "<pre>arrFilter\n",print_r($arrFilter),"</pre>";
