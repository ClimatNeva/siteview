...
<?if (count($arResult["BASKET_ITEMS"]["CAN_BUY"])>0){?>
    ...
    <div class="basket-body-title">
            <div class="pull-right">
					...
					<span class="gray-line"><b><span class="bxr-format-price"><?=$arResult["FORMAT_SUMM"]?></span>
					<span class="bxr-format-price-denom"><?=CurrencyFormat($arResult["SUMM"]*$denomination, $arBasketItem["CURRENCY"])?></span></b></span>
