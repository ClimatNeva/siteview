...
if (!empty($arResult['ITEMS']))
{
	...
	<div class="bx_item_list_you_looked_horizontal col<? echo $arParams['LINE_ELEMENT_COUNT']; ?>">
                                ...
                                <div class="bx_catalog_item_controls bxr-element-action" id="<?=$arItemIDs["BASKET_ACTIONS"]?>">
                                    <?if ($arItem['CAN_BUY']){ ?>
                                        ...
                                        <form class="bxr-basket-action bxr-basket-group bxr-currnet-torg" action="">
                                            ...
                                            <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium bxr-color-button bxr-color-button-small-only-icon" href="javascript:void(0)" rel="nofollow"><?
						...
						?></a>
                                    ...
                                    <?}else{?>
                                        <div class="bx_catalog_item_controls_blockone">
                                            <a class="bxr-color-button bxr-color-button-small-only-icon bx_bt_button_type_2"  href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" rel="nofollow">
                            ...
                            <?} else {// Wth Sku?>
                                ...
                                <div class="bx_catalog_item_controls bxr-element-action no_touch" id="<?=$arItemIDs["BASKET_ACTIONS"]?>">
                                    <div class="bx_catalog_item_controls_blocktwo">
                                        <form class="bxr-basket-action bxr-basket-group bxr-currnet-torg" action="">
                                            <input type="text" name="quantity" value="1" class="bxr-quantity-text" data-item="<?=$arItem['ID']?>">
                                            <a data-href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium bxr-color-button bxr-color-button-small-only-icon" href="javascript:void(0)" rel="nofollow">
                                                <?echo('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CVP_TPL_MESS_BTN_BUY_GIFT'));?>
                                            </a>
                                            <input class="bxr-basket-item-id" type="hidden" name="item" value="<?=$arItem['ID']?>">
                                            <input type="hidden" name="action" value="add">
