if (window){
    window.catalogEcommerceV1List = {
        resizeVerticalBlock: function(){
            ...
            $('.bxr-ecommerce-v2-list[data-resize=1]').each(function(){
...
window.JCCatalogSection.prototype.ChangeInfo = function()
{
	...
	if (-1 < index)
	{
		...
		if (this.showSkuProps && !!this.obSkuProps)
		{
			...
			else
			{
                ...
                $('.bxr-ecommerce-v2-list #'+this.visual.AVAIL_ID+'>div').hide();
                $('.bxr-ecommerce-v2-list #'+this.visual.AVAIL_ID).children('#bxr-offer-avail-'+this.offers[index].ID).show();
                $('.bxr-ecommerce-v2-list #'+this.visual.PRICE_ID+'>div').hide();
                $('.bxr-ecommerce-v2-list #'+this.visual.PRICE_ID).children('#bxr-offer-price-'+this.offers[index].ID).show();
                $('.bxr-ecommerce-v2-list #'+this.visual.BASKET_ACTIONS_ID+'>div').hide();
                $('.bxr-ecommerce-v2-list #'+this.visual.BASKET_ACTIONS_ID).children('#offers-btn-'+this.offers[index].ID).show();
                $('.bxr-ecommerce-v2-list #bxr-element-name-'+this.product.id+' a').html(this.offers[index].NAME);
    ...
    $(document).on("mouseover", ".bxr-ecommerce-v2-list .bxr-trade-request", function() {
        ...
        strParams = "";
        $(this).closest('.bxr-ecommerce-v2-list').find('li.bx_active').each(function() {
