...
if(!\Bitrix\Main\Loader::includeModule("iblock") || !\Bitrix\Main\Loader::includeModule("alexkova.bxready"))
	return;
...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"TAB_ACTION_SETTING" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_ACTION_SETTING_NAME"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"TAB_ACTION_SORT" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_ACTION_SETTING_SORT"),
			"TYPE" => "STRING",
			"DEFAULT" => "100",
		),
		"TAB_RECCOMEND_SETTING" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_RECCOMEND_SETTING_NAME"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"TAB_RECCOMEND_SORT" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_RECCOMEND_SETTING_SORT"),
			"TYPE" => "STRING",
			"DEFAULT" => "200",
		),
		"TAB_NEW_SETTING" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_NEW_SETTING_NAME"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"TAB_NEW_SORT" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_NEW_SETTING_SORT"),
			"TYPE" => "STRING",
			"DEFAULT" => "300",
		),
		"TAB_HIT_SETTING" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_HIT_SETTING_NAME"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"TAB_HIT_SORT" => array(
			"PARENT" => "TABS_SETTING",
			"NAME" => GetMessage("TAB_HIT_SETTING_SORT"),
			"TYPE" => "STRING",
			"DEFAULT" => "400",
		),
