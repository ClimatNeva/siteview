    ...
    <div class="bxr-element-hover-menu">
        ...
        <div class="bxr-element-content">
            <div class="bxr-element-name bxr-children-color-hover">
                ...
                ?>
                <?=$s_ico;?>
                <a href="<?=($_SERVER['REQUEST_URI'] == $v1['LINK'] ? "javascript:void(0);" : $v1['LINK']);?>"><?=$v1["TEXT"]?></a>
	    </div>
            <?if(isset($v1['CHILDREN'])):?>
                <div class="bxr-element-items">
                    <?foreach($v1['CHILDREN'] as $k2 => $v2): ?>
                    <span class="bxr-children-color-hover"><a href="<?=($_SERVER['REQUEST_URI'] == $v2['LINK'] ? "javascript:void(0);" : $v2['LINK']);?>"><?=$v2["TEXT"]?></a></span>
                    <?endforeach;?>
                </div>
            <?endif;?>
        </div>
