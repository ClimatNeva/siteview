...
<div class="bxr-slider <? if($arParams['SLIDER_NAVIGATION_BUTTONS']=="Y") {echo "hover_button";} ?>" style="position: relative">
        ...
        <div class="container <?=$location;?>" style="background: url('<?=$item["DETAIL_PICTURE"]["SRC"]?>');"
            ...
            <?endif;?><div class="col-md-12">
                ...
                <?if(isset($item["PREVIEW_PICTURE"]["SRC"])):?>
                    ...
                    <div class="col-md-6 col-sm-7 col-xs-12 slick-banner-content-content <?=$location?>">
                <?else:?>
                    <div class="col-md-12 slick-banner-content-content <?=$location?>">    
