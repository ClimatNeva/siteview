...
if (strlen($arResult["MESSAGE"]) > 0):?>
	...
	<?return false;?>
<?endif?>
<form id="iblockForm<?=$arParams["IBLOCK_ID"]?>" name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
        <br>
							...
							case "N":
								...
								?>
                                                                ...
                                                                <?if ($inputType != 'textarea') {?>
                                                                    ...
                                                                    <?}?>
                                                                <?} else {?>
                                                                        <textarea name="PROPERTY[<?=$propertyID?>][<?=$i?>]" rows="5" data-code="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"]?>" style="resize: none"><?=$value?></textarea><br /><br />
                                                                <?}?>
	...
	<input onclick="BXReady.Market.formRefresh(<?=$arParams["IBLOCK_ID"]?>);return false;" <?if($arParams["HIDE_SUBMIT"] == 'Y') echo 'style="display: none;"'?> class="color-button bxr-color bxr-color-button bxr-bg-hover-light" id="submitForm_<?=$arParams["IBLOCK_ID"]?>" type="submit" name="iblock_submit" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" />
